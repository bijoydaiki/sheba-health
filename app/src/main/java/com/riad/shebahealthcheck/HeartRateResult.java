...
public class HeartRateResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SHR.setOnClickListener(v -> {
            ...
            i.putExtra(Intent.EXTRA_EMAIL, new String[]{"r@example.com"});
            i.putExtra(Intent.EXTRA_SUBJECT, "Health Check");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(HeartRateResult.this, com.riad.shebahealthcheck.Primary.class);
        i.putExtra("Usr", user);
        startActivity(i);
        finish();
    }
