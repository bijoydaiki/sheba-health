...
public class Cascade {
    ...
    private com.riad.shebahealthcheck.Math.DirectFormAbstract[] m_states;
    ...
    public Complex response(double normalizedFrequency) {
        ...
        for (int i = 0; i < m_numBiquads; i++) {
            ...
            ct = com.riad.shebahealthcheck.Math.MathSupplement.addmul(ct, stage.getB1() / stage.getA0(), czn1);
            ct = MathSupplement.addmul(ct, stage.getB2() / stage.getA0(), czn2);
            cb = com.riad.shebahealthcheck.Math.MathSupplement.addmul(cb, stage.getA1() / stage.getA0(), czn1);
            cb = com.riad.shebahealthcheck.Math.MathSupplement.addmul(cb, stage.getA2() / stage.getA0(), czn2);
            ch = ch.multiply(ct);
