...
public class LayoutBase {
    ...
    public LayoutBase(com.riad.shebahealthcheck.Math.PoleZeroPair[] pairs) {
    ...
    public LayoutBase(int numPoles) {
        ...
        if ((numPoles % 2) == 1) {
            ...
            m_pair = new com.riad.shebahealthcheck.Math.PoleZeroPair[numPoles / 2];
        }
    }
    ...
    public void add(Complex pole, Complex zero) {
        m_pair[m_numPoles / 2] = new com.riad.shebahealthcheck.Math.PoleZeroPair(pole, zero);
        ++m_numPoles;
    }
